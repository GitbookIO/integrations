                            ...
                            <select
                                ...
                                options={{
                                    url: {
                                        ...
                                        pathname: `${
                                            new URL(spaceInstallationPublicEndpoint).pathname
                                        }/projects`,
                                        query: {
                                            v: versionHash,
                                            selectedProject: element.dynamicState('project'),
                                        },
                                    },
                                }}
                            />
                                    ...
                                    <select
                                        ...
                                        options={{
                                            url: {
                                                ...
                                                query: {
                                                    project: element.dynamicState('project'),
                                                    selectedBranch: element.dynamicState('branch'),
                                                    v: versionHash,
                                                },
                                            },
                                        }}
                ...
                >
                    <vstack>
                        ...
                        <input
                            ...
                            hint={
                                <text>
                                    Optional directory of the project to sync with this space in
                                    your repository.{' '}
                                    <link
                                        target={{
                            ...
                            element={<textinput state="projectDirectory" placeholder="./" />}
                        />
                        ...
                        <input
                            ...
                            hint={
                                <text>
                                    Replace the commit message formatting used during export from
                                    GitBook by a custom template.{' '}
                                    <link
                                        target={{
