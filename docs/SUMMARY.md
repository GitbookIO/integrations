...
* [Develop your integration](integrations/development/README.md)
  ...
  * [Client library](integrations/development/browser-node/README.md)
    * [GitBook methods](integrations/development/browser-node/gitbook-methods.md)
...
* [Guides](integrations/guides/README.md)
  * [Creating a custom unfurl action](integrations/guides/create-a-custom-unfurl-action-for-your-integration.md)
  * [Creating interactive blocks](integrations/guides/interactivity.md)
  * [Referencing your integration in Markdown](integrations/guides/markdown.md)
  * [Working with HTTP requests](integrations/guides/receiving-requests.md)
  * [Using the CLI in CI/CD](integrations/guides/ci.md)
  * [Receiving webhook notifications](integrations/guides/webhook.md)
