...
- b2dc5f3: Bump API to 0.189.0

## 0.188.0

### Minor Changes

- 3be6159: Bump to 0.188.0

## 0.187.0

### Minor Changes

- 5c0dbb6: Bump API to latest version

## 0.186.0

### Minor Changes

- 4c4fc84: Bump 0.186.0
...
- 7fe583c: Bump @gitbook/api to use the latest spec

## 0.111.0

### Minor Changes

- 675f801: Bump API client with latest OpenAPI spec
...
- 7714abe: Bump @gitbook/api to use the latest OpenAPI spec
...
- 64be7d6: Update API client with latest OpenAPI spec
...
- 8e1b3e0: Update API client with latest OpenAPI spec
...
- b1b1931: Update API client with latest OpenAPI spec.
...
- ac4735e: Update API client with latest OpenAPI spec
...
- 5238e32: Update API client with latest OpenAPI spec

## 0.90.0

### Minor Changes

- a2fe83c: Update API client with latest OpenAPI spec
...
- d7583bd: Bump API version to include latest sidebar customization settings

## 0.81.0

### Minor Changes

- 5c14848: Bump GitBook API.
...
- 139e499: Bump @gitbook/api to use the latest OpenAPI spec
